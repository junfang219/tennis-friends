    ...
    <div className="max-w-2xl mx-auto px-4 py-6">
      ...
      <section className="bg-white rounded-2xl shadow-sm border border-court-green-pale/20 overflow-hidden mb-4">
        ...
        <Link
          ...
          className="flex items-center gap-3 px-4 py-3 hover:bg-gray-50 transition-colors"
        >
          <div className="w-9 h-9 rounded-full bg-court-green-pale/30 text-court-green flex items-center justify-center shrink-0">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-sm font-semibold text-gray-800">Court alerts</p>
            <p className="text-xs text-gray-500 mt-0.5">
              Manage the courts you&apos;re watching for openings.
            </p>
          </div>
