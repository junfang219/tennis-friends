        ...
        {(() => {
          const FILTER_OPTIONS: {
          ...
          }[] = [
            {
              id: null,
              label: "All",
              activeIconBg: "bg-gray-900/10 text-gray-900",
              activeLabelColor: "text-gray-900",
              icon: (
            ...
            },
            {
              id: "social",
              label: "Social",
              activeIconBg: "bg-court-green-soft/15 text-court-green-soft",
              activeLabelColor: "text-court-green-soft",
              icon: (
            ...
            },
            {
              id: "find_players",
              label: "Find",
              activeIconBg: "bg-court-green/10 text-court-green",
              activeLabelColor: "text-court-green",
              icon: (
            ...
            },
            {
              id: "propose_team",
              label: "Teams",
              activeIconBg: "bg-clay/10 text-clay",
              activeLabelColor: "text-clay",
              icon: (
                <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
            ...
            },
            {
              id: "nearby",
              label: "Nearby",
              activeIconBg: "bg-ball-yellow/30 text-court-green",
              activeLabelColor: "text-court-green",
              icon: (
                <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
          ...
          return (
            <div role="tablist" className="flex items-stretch gap-1 animate-fade-in-up stagger-2 border-b border-gray-100">
                  ...
                  >
                    <span
                      className={`flex items-center justify-center w-9 h-9 rounded-full transition-colors ${
                        selected ? option.activeIconBg : "text-gray-400"
                      }`}
                    >
                      {option.icon}
                    </span>
                    <span
                      className={`text-[10px] leading-none transition-colors ${
                        selected ? `${option.activeLabelColor} font-semibold` : "text-gray-500"
                      }`}
                    >
                      {option.label}
                    </span>
