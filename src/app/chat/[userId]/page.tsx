    ...
    <div data-keyboard-dismiss="off" className={isDesktop ? "absolute inset-0 flex flex-col bg-surface" : "fixed inset-0 z-50 flex flex-col bg-surface"}>
      ...
      */}
      <div
        ...
        // iMessage / WhatsApp convention. Previously the bar floated
        // safe-area-inset-bottom above the edge, leaving a visible gap.
        style={{
      ...
      >
        ...
        <div className="flex items-center gap-2">
          ...
          <input
            ...
            className="flex-1 min-w-0 px-4 py-2.5 border border-gray-200 rounded-full text-sm bg-surface/50 focus:bg-white transition-colors"
          />
