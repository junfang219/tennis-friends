    ...
    <div className="relative w-full" style={{ height: isNative ? "calc(100vh - 64px - 5rem)" : "calc(100vh - 64px)" }}>
      ...
      <div className="flex h-full">
        ...
        <div className="relative flex-1 h-full min-w-0">
          ...
          {/* My court alerts — quick access to manage availability subscriptions. */}
          {mapReady && (
            <Link
              href="/courts/alerts"
              aria-label="My court alerts"
              title="My court alerts"
              className="absolute top-16 right-4 z-[460] w-10 h-10 rounded-full bg-white shadow-md border border-court-green-pale/30 flex items-center justify-center text-court-green hover:bg-court-green-soft/10"
            >
