/**
 * Seattle tennis courts (City of Seattle parks).
 * Sources: City of Seattle ArcGIS, seattle.gov/parks facility pages.
 * This list has been stable since the original Court Finder release.
 */
...
export const SEATTLE_COURTS: CuratedCourt[] = [
